                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Laporan - Surat - Keluar</h2>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $query = mysqli_query($conn,"SELECT * FROM `data_surat` WHERE jenis_surat='keluar' ORDER BY `data_surat`.`tgl_diterima` ASC" ) ;
                                                $no = 1;
